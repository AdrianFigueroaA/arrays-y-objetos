...
// 1 - agregar nuevas horas al arreglo de traumatologia
...
// 2 - borrar primer y ultimo elemento de radiologia 
  radiologia.shift();
  radiologia.pop();

//3 - imprimir lista dental
...
//4 -  Imprimir  listado total de pacientes que se atendieron
...
// 5 - modificar prevision en pacientes dental 
    ...
    let newDental = dental.map(consulta => {
      ...
      newDental.forEach(consulta => {
        document.write(`<p> ${consulta.prevision};${consulta.paciente}</p>`);
      });
